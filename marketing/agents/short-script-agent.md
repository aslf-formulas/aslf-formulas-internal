...
- **Promo mode** — promotional Short designed to drive viewers to an ASLF long-form video. Two variants are produced per long-form (different hooks, same target). These are recorded **separately** — not cut from the long-form footage.
...
**For promo mode:**
- Which long-form video is this promoting? (Path to script file)
...
2. Drafts script(s) per the format below
...
- STANDALONE — evergreen anti-aging/longevity Short
- PROMO — promotional Short driving viewers to an ASLF long-form video (2 variants per long-form)
...
1. Which long-form video is this promoting? (Path to the script file at marketing/scripts/long-form/)
...
3. What's the CTA? Default for promo: "Watch the full breakdown on YouTube — link in bio."
...
- Section 3 (Platform rules) — apply ALL platforms the Short will publish to (typically TikTok, YouTube Shorts, IG Reels — assume the strictest, which is TikTok)
...
For PROMO mode, produce TWO variants with different hooks.
...
Standalone: typically "Follow for more / drop your questions below"
Promo: "Watch the full breakdown on YouTube — link in bio"

[CAPTION]
Write the caption that will appear under the Short on TikTok, IG, and YouTube Shorts. Include:
- 1–2 sentence summary
- The required disclaimer line
- 3–5 hashtags (mix of broad, mid-tier, brand-specific) — apply section 3.2 TikTok rules (no disease names in hashtags)

STEP 2D — COMPLIANCE REVIEW (AUTO)

After drafting, invoke AGT-018 with:
- The full draft (including caption and on-screen text)
...
- # [Title]
- *Recorded: [Month YYYY] | Format: Vertical Short | Target: 30–90s*
...
| **Status** | Active |
| **Output** | Standalone: full script + caption saved to `marketing/scripts/standalone-shorts/`. Promo: 2 variants appended to long-form script file. |
| **Last Updated** | May 2026 |
