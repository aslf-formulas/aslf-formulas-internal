...
- Every cited study: plan a real study snapshot (title + authors + journal), not generic paper stock. 1.5–2.5s. Source URL from the script only. Weekly news packs: Content Creator delivers **full (uncropped) browser screenshots** of study/press pages into `snapshots/` for Premiere; Philipp crops/adapts in Premiere.
...
3. **Study / press snapshots** when Researcher provides a URL (~1.5–2.5s) — one per story when possible. Weekly news packs: Content Creator delivers **full (uncropped) browser screenshots** into `snapshots/`; Philipp crops/adapts in Premiere.
