...
| Texas State | 6.25% |
| City of Austin | 1.00% |
| CapMetro (transit district) | 1.00% |
| Travis County | 0.00% |
| **Combined Total** | **8.25%** |

Apply **8.25%** to all taxable sales made at or shipped from the Austin location.
...
Returns and payment are due by the **20th of the month following the reporting period**.

| Month Reported | Due Date |
|---|---|
| January | February 20 |
| February | March 20 |
| March | April 20 |
...
| December | January 20 (following year) |
...
| Account | Debit | Credit |
|---|---|---|
| Sales Tax Payable | Full liability | |
| Cash | | Discounted amount paid |
| Other Income (Tax Discount) | | Discount amount |
