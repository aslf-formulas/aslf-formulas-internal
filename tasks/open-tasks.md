...
| 10 | **Amazon Storefront Embellishment** | Owner Action | A+ Content is done (see Completed Tasks). Still missing: the storefront page itself needs visual embellishment/design work (banners, layout, brand styling) beyond the individual product A+ Content. | — |
...
| 14 | **Sales Tax Nexus Review — Identify State(s)** | Owner Action | Owner believes revenue in another state crossed the economic nexus threshold, which would require sales tax registration/filing there. State is not yet known — first step is to review order/revenue data by state against each state's economic nexus thresholds (commonly $100K in sales or 200 transactions annually, varies by state) to identify which state(s), if any, are triggered. Once identified, register and begin filing in that state. | TBD |
...
| Texas Sales Tax Permit Registration | March 2026 | Permit arriving by mail |
...
| Chase Business Credit Card — Follow Up | August 2026 | Approved via reconsideration line |
| Densidyl Before/After Photos (Dropped) | August 2026 | Decided not to pursue — product doesn't isolate Densidyl at a level that supports using customer photos as direct clinical-style proof |
| Hair Serum How-To Card (Not Needed) | August 2026 | Usage instructions and expected-results timeline now covered directly in the product listing — separate card not needed |
| LLC Operating Agreement (Dropped) | August 2026 | Not legally required for a single-member Texas LLC — owner decided not to pursue for now |
